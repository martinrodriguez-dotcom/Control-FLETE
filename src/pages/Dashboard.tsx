...
import { LayoutDashboard, TrendingUp, TrendingDown, Filter, DollarSign, Activity, CheckCircle2, Circle, Map, Receipt, Calendar, Database, Droplets, AlertTriangle } from 'lucide-react';
...
export const DashboardView: React.FC<DashboardProps> = ({ trips, expenses, fuel, units, clients }) => {
  ...
  // --- CÁLCULOS DEL GRÁFICO (SOLO VEHÍCULOS) ---
  ...
  return (
    <div className="space-y-6">
      ...
      {/* VISTA DE TANQUES DE COMBUSTIBLE EN TIEMPO REAL */}
      ...
      <Card className="p-0 overflow-hidden shadow-sm border border-slate-200 dark:border-slate-700">
        <div className="p-5 border-b border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50">
          ...
          <p className="text-sm text-slate-500 mt-1">Comparativa de Ingresos vs. Egresos en el período seleccionado.</p>
                ...
                <div key={data.unit.id} className="relative">
                  ...
                  <div className="flex items-center gap-3 mb-1.5">
                    ...
                    <div className="flex-1 h-5 bg-slate-100 dark:bg-slate-800 rounded-r-md overflow-hidden flex items-center">
                      <div className="h-full bg-emerald-500 transition-all duration-1000" style={{ width: `${revenuePct}%`, minWidth: data.revenue > 0 ? '4px' : '0' }} />
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 h-5 bg-slate-100 dark:bg-slate-800 rounded-r-md overflow-hidden flex items-center">
                      <div className="h-full bg-red-500 transition-all duration-1000" style={{ width: `${costsPct}%`, minWidth: data.costs > 0 ? '4px' : '0' }} />
                    </div>
