...
Por último, debemos enlazar estas dos nuevas pantallas. En tu `App.tsx`, realiza estos dos pequeños cambios:

**En la parte superior (Importaciones):**
Importa las nuevas vistas y borra la vieja lógica de `expenses` del `SimpleCRUD`.

```tsx
// Agrega estas dos importaciones junto a las otras Vistas (DashboardView, UnitsView, etc)
import { ExpensesView } from './pages/Expenses';
import { ReportsView } from './pages/Reports';
```

**En el bloque del `<main>` (donde se renderizan las vistas):**
Reemplaza los bloques de `view === 'expenses'` y `view === 'reports'` por esto:
